        ...
        <div className="w-full p-3 max-w-7xl">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex gap-2 items-center">
              ...
              <TimePicker
                onChange={(value) => setValue("walking_time__bus", value)}
                registerProps={{
                  ...register("walking_time__bus", {
            ...
            <div className="flex gap-2">
              <label htmlFor="time_taken_bus_stop" className="pt-3">
                Movie time
              </label>
                    ...
                    <Fragment key={field.id}>
                      <TimePicker
                        ...
                        registerProps={register(
                          `time_taken_bus_stop.${index}.value`
                        )}
                      />
                    </Fragment>
                  );
